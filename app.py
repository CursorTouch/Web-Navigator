...
from src.tool.thinking import thinking_tool
...
agent = WebAgent(config=config, additional_tools=[thinking_tool],llm=llm,verbose=True,use_vision=True,max_iteration=100,include_human_in_loop=False,token_usage=False)
